...
func ccnValidator(s string) error {
	...
	if s == "" {
		return fmt.Errorf("CCN is empty")
	}
...
func InitialCardPageModel() CardPageModel {
...
func (m CardPageModel) Init() tea.Cmd {
	return textinput.Blink
}

func (m CardPageModel) Update(msg tea.Msg) (CardPageModel, tea.Cmd) {
...
func (m CardPageModel) View() string {
	return fmt.Sprintf(
		` Total: $21.50:
 %s
 %s
...
func (m *CardPageModel) nextInput() {
	// Wrap around
	if m.focused < 0 {
...
func (m *CardPageModel) prevInput() {
	m.focused--
	// Wrap around
	if m.focused < 0 {
		m.focused = len(m.inputs) - 1
